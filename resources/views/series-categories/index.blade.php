...
@section('content')
            ...
            <div class="col-10">
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">{{ __('series categories') }}</span>
                        <span class="float-right">
                            <a class="btn btn-success" href="{{Route('admin.series-categories.create')}}"><i
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <table id="table" data-toggle="table" data-show-columns="true"
                                   data-search="true"
                                   data-show-columns-toggle-all="true" data-data="{{$seriesCategories}}">
                                <thead>
                                <tr>
    ...
    <script src="{{ asset('js/pages/series-categories.js') }}"></script>
