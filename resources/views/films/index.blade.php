...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <span class="float-left">{{ __('films') }}</span>
                        <span class="float-right">
                            <a class="btn btn-success" href="{{Route('admin.films.create')}}"><i
                    ...
                    <div class="card-body">
                        ...
                        <table id="table" data-toggle="table" data-show-columns="true"
                               data-search="true"
                               data-show-columns-toggle-all="true" data-data="{{$films}}" >
                            <thead>
                            <tr>
    ...
    <script src="{{ asset('js/pages/films.js') }}"></script>
